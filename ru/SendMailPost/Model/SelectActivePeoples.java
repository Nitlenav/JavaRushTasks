...
public class SelectActivePeoples implements ModelData {
    private Object [][] selectData ;
    private String [] columnNameSelectData;
    @Override
    public String[] getColumnNameSelectData() {
        return columnNameSelectData = new String[]{"Бух. код", "Ф.И.О. клиента", "Электронный адрес"};
    }
    ...
    public Object[][] getSelectData(){
        try {
            ...
            for (int i = 0; i < allData.length; i++){
                if (allData[i][6].equals("Сбербанк")&& !(allData[i][3].equals("998")) && !(allData[i][5].equals(""))) {
